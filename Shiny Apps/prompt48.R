      ...
      tabsetPanel(
        tabPanel("Data Editor", 
                 helpText("On this page, you can:",
                          tags$ul(tags$li("Upload a CSV file"),
                                  tags$li("View and edit the dataset in a table format")),
                          "To edit a value, simply double-click on the cell and enter the new value."),
                 DTOutput("dataTable")),
        tabPanel("Data Visualizer",
                 helpText("On this page, you can:",
                          tags$ul(tags$li("Select a chart type"),
                                  tags$li("Choose variables for the x and y axes"),
                                  tags$li("Optionally, set a color variable")),
                          "Scatterplot: Use to show relationships between two continuous variables.",
                          "Histogram: Use to display the distribution of a single continuous variable.",
                          "Line Chart: Use to show trends in data over time or other continuous variables.",
                          "Box Plot: Use to display the distribution and summary statistics of a continuous variable across different categories.",
                          "Bar Chart: Use to compare categorical data."),
                 fluidRow(
