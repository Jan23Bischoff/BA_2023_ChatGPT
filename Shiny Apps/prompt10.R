...
server <- function(input, output, session) {
  ...
  output$variable_selectors <- renderUI({
    ...
    selectInput("dependent_variable", "Dependent Variable:", choices = names(dataset()))
    selectInput("independent_variables", "Independent Variables:", choices = names(dataset()), multiple = TRUE)
  })
